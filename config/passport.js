...
//(1) jwt already verified that the token is valid, pass the payload object which contains ID of user (the sub field) in db.
...
const strategy = new jwtStrategy(options, verifyCallback) //(2) this verifies if the token is valid based on the passed options
